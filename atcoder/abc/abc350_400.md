...
### Solution 1:  map, index maping, swap
...
void solve() {
    cin >> N >> Q;
    vector<int> pigeonMap(N, 0);
    iota(pigeonMap.begin(), pigeonMap.end(), 0);
    vector<int> indexMap(N, 0);
    iota(indexMap.begin(), indexMap.end(), 0);
    vector<int> pigeonIndexMap(N, 0);
    iota(pigeonIndexMap.begin(), pigeonIndexMap.end(), 0);
    while (Q--) {
        int t, a;
        cin >> t >> a;
        a--;
        if (t == 1) {
            ...
            debug("index", indexMap, "\n");
            pigeonIndexMap[indexMap[a]] = a;
            pigeonIndexMap[indexMap[b]] = b;
        } else {
            int ans = indexMap[pigeonMap[a]];
            cout << ans + 1 << endl;
        }
        debug(pigeonIndexMap, "\n");
